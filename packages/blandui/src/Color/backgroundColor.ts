...
export default {
	...
	'btn-brand-secondary-rest':     colors.carbon[100],
	'btn-brand-secondary-hover':    colors.carbon[200],
	'btn-brand-secondary-pressed':  colors.carbon[400],
	'btn-brand-secondary-focused':  colors.carbon[100],
	'btn-brand-secondary-disabled': colors.gray[300],

	'btn-brand-ghost-rest':     'transparent',
	'btn-brand-ghost-hover':    colors.carbon[200],
	'btn-brand-ghost-pressed':  colors.carbon[400],
	'btn-brand-ghost-focused':  'transparent',
	'btn-brand-ghost-disabled': 'transparent',

	'btn-brand-stroke-rest':     'transparent',
	'btn-brand-stroke-hover':    colors.carbon[200],
	'btn-brand-stroke-pressed':  colors.carbon[400],
	...
	// BADGE
	'badge-brand-primary':   colors.carbon[1000],
	'badge-brand-secondary': colors.carbon[50],

	'badge-gray-primary':   colors.gray[1000],
	'badge-gray-secondary': colors.gray[50],

	'badge-green-primary':   colors.green[700],
	'badge-green-secondary': colors.green[50],

	'badge-red-primary':   colors.red[600],
	'badge-red-secondary': colors.red[50],
	...
	'surface-1': colors.gray[200],
	'surface-0': colors.gray[300],

	'surface-brand':       colors.carbon[1000],
	'surface-inverse':     colors.gray[1000],
	'surface-brand-light': colors.gray[50],

	'surface-danger':       colors.red[700],
	'surface-danger-light': colors.red[50],

	'surface-success':       colors.green[600],
	'surface-success-light': colors.green[50],

	'surface-warning':       colors.amber[600],
	'surface-warning-light': colors.amber[50],
